...
public class ContaTest {
    ...
    public void testarContaInvestimento() {
        Correntista Eduardo = new Correntista("Eduardo", 4123123);
        Conta contaDoEduardo = new Conta(3007,Eduardo);
        Eduardo.setConta(contaDoEduardo);

        ContaInvestimento contaInvestimentoDoEduardo = new ContaInvestimento(3007, Eduardo, "Compostos", 2);

        contaInvestimentoDoEduardo.aplicarJuros();

        assertEquals("Checar se o saldo depois do juros esta correto",
                10.2,
                contaInvestimentoDoEduardo.getSaldoEmReais(),FLOAT_DELTA);

        contaInvestimentoDoEduardo.resgatarTotal();

        assertEquals("Checar se o saldo foi transfereido da conta investimento para conta corrente",
                20.2,
                contaDoEduardo.getSaldoEmReais(),FLOAT_DELTA);
